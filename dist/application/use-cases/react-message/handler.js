...
exports.ReactMessageHandler = void 0;
const app_1 = require("../../app");
const app_command_1 = require("app-command");
const models_1 = require("../../../domain/models");
const inversify_1 = require("inversify");
const command_1 = require("./command");
let ReactMessageHandler = class ReactMessageHandler extends app_command_1.AppCommandHandler {
    ...
    handle(commandId, commandMetadata, commandPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const reaction = new models_1.Reaction({ value: reactionValue });
            const messageReaction = yield this.domainServiceRegistry
                .messageService()
                .reactMessage(userId, chatId, messageId, reaction);
            yield this.repoRegistry.messageReactionRepo().save(messageReaction);
            return this.complete(messageReaction.id());
        });
    }
};
exports.ReactMessageHandler = ReactMessageHandler;
exports.ReactMessageHandler = ReactMessageHandler = __decorate([
    (0, inversify_1.injectable)(),
    (0, app_command_1.HandlerForCommand)(command_1.ReactMessageCommand),
